...
/** @type {string} */
const CACHE_VERSION = '1748170912|3751945897';
/** @type {string} */
const CACHE_PREFIX = '千恋*万花-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = '千恋万花.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["千恋万花.html","千恋万花.js","千恋万花.offline.html","千恋万花.icon.png","千恋万花.apple-touch-icon.png","千恋万花.audio.worklet.js","千恋万花.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["千恋万花.wasm","千恋万花.pck"];
